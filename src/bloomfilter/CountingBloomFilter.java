...
public class CountingBloomFilter {
	...
	public CountingBloomFilter(double aFP,List<?> init,Class<?> cl){
		initialize(aFP,init.size(),typeHashing,cl);
		this.addAll(init);
	}
	
	public CountingBloomFilter(double aFP,List<?> init,String typeHashing,Class<?> cl){
		initialize(aFP,init.size(),typeHashing,cl);
		this.addAll(init);
	}
	
	public CountingBloomFilter(double aFP,int expectedNElement,Class<?> cl){
		initialize(aFP,expectedNElement,typeHashing,cl);
		
	}
	
	public CountingBloomFilter(double aFP,int expectedNElement,String typeHashing,Class<?> cl){
		initialize(aFP,expectedNElement,typeHashing,cl);
	}
	
	public CountingBloomFilter(double aFP,List<?> init,int expectedNElement,Class<?> cl){
		initialize(aFP,expectedNElement,typeHashing,cl);
		this.addAll(init);
	}
	
	public CountingBloomFilter(double aFP,List<?> init,int expectedNElement,String typeHashing,Class<?> cl){
		initialize(aFP,expectedNElement,typeHashing,cl);
		this.addAll(init);
	}
	
	public CountingBloomFilter(int aM, int aN, int aK,double aFp_obj, String typeHashing,Object aSet,int numberOfAddedElement,Class cl){
		n=aN;
		fp_obj=aFp_obj;
		m=aM;
		k=aK;
